...
<Card title="Flow Control" icon="code-branch" href="/actions/flow-control">
  Run multiple trading checks in parallel.
</Card>

<Card title="Memory" icon="memory" href="/actions/memory">
  Cache price data for faster lookups.
</Card>

<Card title="Communication" icon="envelope" href="/actions/communication">
