...
- **[Tools](/references/actions)**: what the agent can decide to do while it works, such as query a database, hit an API, transform data, or run a workflow. The same building blocks compose workflows.
...
- **Integrations and [secrets](/concepts/secrets)**: the AI models, databases, and APIs the agent is allowed to use, with credentials stored encrypted and out of your configs.
