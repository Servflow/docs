...
- **[Tools](/concepts/actions/overview)**: what the agent can decide to do while it works, such as query a database, hit an API, transform data, or run a workflow. The same building blocks compose workflows.
