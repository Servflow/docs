...
ServFlow running with the dashboard enabled:
...
Everything here is also reachable from the CLI: this agent and workflow can be listed, exported, and edited with `servflowai resource`.
