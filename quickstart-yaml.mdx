...
<Tip>
See the [Actions Reference](/actions/overview) for all available action types and their configurations.
</Tip>
...
<Card title="Actions Reference" icon="play" href="/actions/overview">
