...
<Note>
Memory storage persists across workflow executions but is cleared when the server restarts. For persistent storage, use [Data Operations](/concepts/actions/data-operations).
</Note>
