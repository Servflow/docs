...
- Limit the channels the bot answers in, under **Runs when** in the agent's entry. See [Connect an agent to Discord](/guides/connect-an-agent-to-discord#set-the-agents-entry-to-discord).
