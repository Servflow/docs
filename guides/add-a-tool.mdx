...
**Add a tool…** lists three more types. Each opens the same dialog with a different middle section. For every field, see the [Tools reference](/concepts/tools).
...
Every sub-agent already has `read_memory`, `write_memory`, and `list_memory`, with nothing to attach. They work in the folder chosen under **Workspace** in the panel's **Memory** section. See [Built-in tools](/references/cli#built-in-file-tools). To set a workspace up, see [Set up memory and file access](/guides/set-up-memory-and-file-access).
...
<Card title="Tools" icon="wrench" href="/concepts/tools">
  The four kinds of tool, and what the agent fills in.
</Card>
