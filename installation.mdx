...
- **Encrypt secrets at rest.** Set `master_key` under `[sqlite]`, and set it through the `SERVFLOW_SQLITE_MASTER_KEY` environment variable rather than the file. See [Secrets](/concepts/secrets).
