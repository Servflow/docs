...
## YAML Configuration (Code-First)

Actions can also be defined directly in YAML configuration files. This approach is equally valid as the dashboard UI and is preferred for:
...
<Tip>
See [Running Modes](/running-modes) to understand when to use the dashboard vs. YAML-first workflows, and the [YAML Quickstart](/quickstart-yaml) for a complete tutorial.
</Tip>
